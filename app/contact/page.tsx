...
"
        ...
        <div>
          <button
            type="submit"
            className="px-6 py-3 bg-gray-800 text-white font-medium rounded-3xl hover:bg-gray-700 transition duration-300 focus:outline-none focus:ring-2 focus:ring-gray-500"
          >
            Send Message
          </button>
        </div>
