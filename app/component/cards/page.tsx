            ...
            <div className="container mx-auto px-6 py-16 " id="about">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white p-14 rounded-2xl shadow-lg relative">
                        <div className="text-gray-500 text-4xl mb-10">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="rgba(44, 57, 67, .4)" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" className="feather feather-users=feather feather-bar-chart"><line x1="12" y1="20" x2="12" y2="10"></line><line x1="18" y1="20" x2="18" y2="4"></line><line x1="6" y1="20" x2="6" y2="16"></line></svg>
                        </div>
